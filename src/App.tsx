            ...
            <div className="order-2 lg:order-1 relative isolate">
                ...
                <div className="grid grid-cols-2 gap-4 relative z-10">
                    <div className="space-y-4 pt-12">
                        {[
                            "/problem-screenshot-1.jpg", // Slot 1: Cluttered Track List Spreadsheet
                            "/problem-screenshot-2.jpg"  // Slot 2: 59 Inactive Mobile Tabs
                        ].map((src, i) => (
                    ...
                    <div className="space-y-4">
                        {[
                            "/problem-screenshot-3.jpg", // Slot 3: Huge Manual Manga Tracker Spreadsheet
                            "/problem-screenshot-4.jpg"  // Slot 4: 403 Forbidden Server Error Page
                        ].map((src, i) => (
